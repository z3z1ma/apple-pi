...
My own personal [Pi](https://github.com/badlogic/pi-mono) package: sentinel, questions, session backlog and active to-dos, context, exec, subagents, and the workflow skills I actually use.
...
- [`Sentinel`](docs/sentinel.md) — optional persistent supervision with episodic deep Advisor escalation
...
See [`docs/development.md`](docs/development.md) for module conventions. Networked sentinel E2E is opt-in: `SENTINEL_E2E=1 npm run test:sentinel`.
