...
- **[Input Editor (`input-editor`)](docs/input-editor.md)**: Keeps the custom left-rail editor and model metadata while removing the bottom rail and footer row, displaying a muted `pair · mcp:N · ctx X%` indicator right-justified on the bottom of the editor.
