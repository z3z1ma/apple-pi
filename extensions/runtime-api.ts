...
export const GUEST_HELPER_SIGNATURES: string[] = [
	...
	"type AgentRequest = string | { task: string, name?: string, model?: string, thinking?: AgentThinking, tools?: AgentTool[], systemPrompt?: string, context?: JSONValue, outputSchema?: object }",
	...
	'agent tools default to ["read","grep","find","ls"]; tools must be chosen from AgentTool',
	"agent(...) is a pi_exec worker. extensions.Agent(...) is the interactive subagent tool.",
