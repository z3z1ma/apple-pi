...
export const GUEST_HELPER_SIGNATURES: string[] = [
	...
	"Workers load Codex fast mode, the proactive overflow guard, ledger, and search_session extensions. They do not load pi_exec or the subagent manager, and they cannot call MCP. Call those in the program, then bind the compact result as context.",
