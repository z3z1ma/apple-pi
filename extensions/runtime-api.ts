...
export const GUEST_HELPER_SIGNATURES: string[] = [
	...
	"type AgentRequest = string | { task: string, type?: string, name?: string, profile?: InferenceProfile, tools?: AgentTool[], sentinel?: boolean, systemPrompt?: string, context?: JSONValue, outputSchema?: object }",
	...
	"Workers load Codex fast mode, the proactive overflow guard, ledger, and session_search extensions. They do not load pi_exec or the subagent manager, and they cannot call MCP. Call those in the program, then bind the compact result as context.",
