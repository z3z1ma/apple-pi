 ...
 * The pair programmer owns the root-only notebook ledger, packet, recall, and compaction
 * integration so there is one model-facing companion rather than a second persistent notebook actor.
 */
