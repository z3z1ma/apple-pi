...
const EXCLUDED_TOOL_NAMES = new Set(["pi_exec", "monitor", "schedule", "task", ...Object.values(SUBAGENT_TOOL_NAMES)]);
...
export const installRegisteredToolCapture = (): void => {
	...
	prototype.getAllRegisteredTools = function getApplePiRegisteredTools(): RegisteredTool[] {
		...
		// The pair programmer and other auxiliary sessions may assemble their own catalogs
