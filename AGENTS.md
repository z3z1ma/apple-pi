...
| `components/home-search-guard/` | Blocks agent searches from unsafe filesystem, home, and workspace collection roots | Covers root, pair, children, workers, and direct Pi Exec core-tool calls while forcing searches into a specific repository, worktree, or subdirectory. |
