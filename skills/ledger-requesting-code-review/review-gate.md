...
Use this adapter when a Ledger lifecycle skill requires a bounded specification, plan, Work Item, or scoped-fix review through the general `pi-review` composition boundary. Whole-change review is deliberately excluded.
