...
- ✅ Good: `**REQUIRED SUB-SKILL:** Use test-first-development`
- ✅ Good: `**REQUIRED BACKGROUND:** You MUST understand root-cause-debugging`
- ❌ Bad: `See skills/testing/test-first-development` (unclear if required)
- ❌ Bad: `@skills/testing/test-first-development/SKILL.md` (force-loads, burns context)
...
**REQUIRED BACKGROUND:** The test-first-development skill explains why this matters. Same principles apply to documentation.
