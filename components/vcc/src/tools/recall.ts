...
import { expandEntryFile, expandToolCall, parseCallQuery, parseDrillDown } from "../core/drill-down.js";
...
import { getFileIndicators, getTouchedFiles, type SearchHit, searchEntries } from "../core/search-entries.js";
...
export const sessionSearchTool = defineTool({
	...
	async execute(_toolCallId, params, _signal, _onUpdate, ctx) {
		...
		if (callId) {
			const { rawMessages } = loadAllMessages(sessionFile, false, lineageEntryIds, entryFilter);
			return {
